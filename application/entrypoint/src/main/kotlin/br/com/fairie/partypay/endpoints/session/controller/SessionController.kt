...
class SessionController(
    ...
    fun cancelOrder(@PathVariable sessionId: Long, @PathVariable orderId: Long): ResponseEntity<SessionDTO> {
        val session = useCase.cancelOrder(sessionId, orderId).toDTO()
